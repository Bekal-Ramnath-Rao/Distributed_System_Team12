...
class Client():
    def __init__(self,broadcast_address,broadcast_port,args):
        ...
        # Create a UDP socket
        self.udp_socket = socket_handler.configure_socket_UDP(False,True)               
        #Create a TCP socket
        self.tcp_socket = socket_handler.configuresocketTCP()
    ...
    def server_connect(self,broadcast_address,broadcast_port,arg):        
        ...
        # Send data
        socket_handler.sendmessagethroughUDP(self.udp_socket,message.encode(),(broadcast_address, broadcast_port))
    ...
    def buy_sell_stocks(self,message):
        socket_handler.sendMessagethroughTCPSocket(self.tcp_socket,message)
        print("Sent Trading information & Waiting for response...")
        data,server = socket_handler.recvMessagefromTCPSocket(self.tcp_socket)
