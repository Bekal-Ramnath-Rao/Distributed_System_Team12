...
def setsharehandlerobject(sharehandler_object):
    global sharehandler
    sharehandler = sharehandler_object

def getsharehandlerobject():
    global sharehandler
    return sharehandler
...
if __name__ == "__main__":
    ...
    # setclientsharehandlerobject(clientsharehandler)
    # setsharehandlerobject(sharehandler)   
    # print('ID of the sharehandler object is ', id(sharehandler))
    ...
    if getleaderstatus():
        ...
        heartbeat.run()
        multicaster = data_multicast_handler.MulticastHandler(global_data, clientsharehandler, sharehandler, client_share, lcr_obj, do_serialization,getleaderstatus,getclientsharehandlerobject,getclientshareobject,getsharehandlerobject,get_machines_ip())
        multicaster.run()
    else:
        udp_thread_for_election = threading.Thread(target=udp_server_managing_election,
                                                   args=(udp_socket_listener_for_election,
                                                         lcr_obj, getleaderstatus(),clientsharehandler, sharehandler, client_share, global_data))
        client_share = None
